...
class Position(Worker):
    ...
    def get_total_income(self):
        value = self._income["wage"] + self._income["bonus"]
        print(f'Доход с учетом премии составляет: {value}')

my_position = Position('Александр', 'Невкипелов', 'сантехник', 80000, 15000)
